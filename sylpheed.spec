...
#Source0:	http://sylpheed.good-day.net/sylpheed/v2.1/%{name}-%{version}.tar.bz2
Source0:	http://sylpheed.good-day.net/sylpheed/test/%{name}-%{version}pre1.tar.bz2
# Source0-md5:	27ea4dfcb289e7f8f6bd41e56f4b7dfb
